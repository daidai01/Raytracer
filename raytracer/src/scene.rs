...
pub fn solar_system() -> HittableList {
    let mut objects = HittableList::new();
    let background = Lambertian::new(ImageTexture::new("jpg/background.jpg"));
    let sun = Lambertian::new(ImageTexture::new("jpg/sun.jpg"));
    let mercury = Lambertian::new(ImageTexture::new("jpg/mercury.jpg"));
    let venus = Lambertian::new(ImageTexture::new("jpg/venus.jpg"));
    let earth = Lambertian::new(ImageTexture::new("jpg/earthmap.jpg"));
    let mars = Lambertian::new(ImageTexture::new("jpg/mars.jpg"));
    let jupiter = Lambertian::new(ImageTexture::new("jpg/jupiter.jpg"));
    let saturn = Lambertian::new(ImageTexture::new("jpg/saturn.jpg"));
    ...
    objects.add(Arc::new(Sphere::new(
        Vec3::new(-28.0, 400.0, 28.0),
        10.0,
        mercury,
    )));
    objects.add(Arc::new(Sphere::new(
        Vec3::new(80.0, 400.0, 0.0),
        38.0,
        venus,
    )));
    objects.add(Arc::new(Sphere::new(
        Vec3::new(84.0, 400.0, 84.0),
        40.0,
        earth,
    )));
    objects.add(Arc::new(Sphere::new(
        Vec3::new(150.0, 400.0, 150.0),
        25.0,
        mars,
    )));
    objects.add(Arc::new(Sphere::new(
        Vec3::new(-280.0, 400.0, -280.0),
        80.0,
        jupiter,
    )));
    objects.add(Arc::new(Sphere::new(
    ...
    objects.add(Arc::new(Sphere::new(
        Vec3::new(630.0, 400.0, -630.0),
        50.0,
        uranus,
    )));
    objects.add(Arc::new(Sphere::new(
        Vec3::new(-1000.0, 400.0, 0.0),
        48.0,
        neptune,
    )));

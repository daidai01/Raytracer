...
pub use aabb::AABB;
pub use bvh_static::bvhNode;
pub use camera::Camera;
pub use cornell_box_static::Box;
pub use hittable_static::{ConstantMedium, FlipFace, HitRecord, Hittable, RotateY, Translate};
pub use hittable_list::HittableList;
use image::{ImageBuffer, RgbImage};
use indicatif::ProgressBar;
pub use material_static::{Dielectric, DiffuseLight, Lambertian, Material, Metal};
pub use onb::ONB;
pub use pdf::{CosinePDF, HittablePDF, MixturePDF, PDF};
use rand::{thread_rng, Rng};
pub use ray::Ray;
pub use rectangle_static::{xyRect, xzRect, yzRect};
pub use sphere_static::{MovingSphere, Sphere};
pub use texture_static::{CheckerTexture, ImageTexture, NoiseTexture, Texture};
use std::sync::Arc;
pub use vec3::Vec3;
use crate::texture_static::SolidColor;
use crate::material_static::Isotropic;
...
fn cornell_box() -> HittableList {
    ...
    let box1: Arc<dyn Hittable> = Arc::new(Translate::new(box1_temp2, Vec3::new(265.0, 0.0, 295.0)));
    objects.add(box1);
...
fn final_scene() -> HittableList {
    ...
    let emat = Lambertian::new(ImageTexture::new(
        "earthmap.jpg",
    ));
    objects.add(Arc::new(Sphere::new(
